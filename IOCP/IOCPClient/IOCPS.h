...
#define MINIMUMPACKAGESIZE sizeof(UINT)      //”¶∏√ «1
...
private: 
	...
	// Anv‰nds fˆr att binda alla socets till GetQueuedCompletionStatus
	HANDLE					m_hCompletionPort;
	// Om vi fÂr en connecction request.. 
	HANDLE					m_hEvent; 
	// Socket som vi anv‰nder fˆr att lyssna... 
	SOCKET					m_socListen;   
	// TrÂden som lyssnar p?connections 
